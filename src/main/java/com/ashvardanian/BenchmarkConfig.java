...
public class BenchmarkConfig {
    ...
    public enum BenchmarkMode {
        ...
        BenchmarkMode(String name) { this.name = name; }
    ...
    public enum Precision {
        ...
        private final String name;
        Precision(String name) { this.name = name; }
        public String getName() { return name; }
    ...
    private void parseAdditionalConfig() {
        ...
        if (additionalConfig.containsKey("maxConnections")) {
            this.maxConnections = Integer.parseInt(additionalConfig.get("maxConnections"));
        }
        if (additionalConfig.containsKey("efConstruction")) {
            this.efConstruction = Integer.parseInt(additionalConfig.get("efConstruction"));
        }
        if (additionalConfig.containsKey("efSearch")) {
            this.efSearch = Integer.parseInt(additionalConfig.get("efSearch"));
        }
    ...
    public static BenchmarkConfig parseArgs(String[] args) {
        ...
        for (int i = 1; i < args.length; i++) {
            ...
            } else if ("--ef-construction".equals(arg) && i + 1 < args.length) {
                additionalConfig.put("efConstruction", args[++i]);
            } else if ("--ef-search".equals(arg) && i + 1 < args.length) {
                additionalConfig.put("efSearch", args[++i]);
            } else if ("--max-connections".equals(arg) && i + 1 < args.length) {
                additionalConfig.put("maxConnections", args[++i]);
    ...
    public List<Precision> getPrecisions() { return precisions; }
    ...
    public int[] getKValues() { return kValues; }
    public int getMaxConnections() { return maxConnections; }
    public int getEfConstruction() { return efConstruction; }
    public int getEfSearch() { return efSearch; }
    public boolean isIncludeIndexingTime() { return includeIndexingTime; }
    public boolean isIncludeMemoryUsage() { return includeMemoryUsage; }
