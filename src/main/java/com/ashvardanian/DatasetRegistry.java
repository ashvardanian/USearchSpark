...
public class DatasetRegistry {
    ...
    public static class DatasetDefinition {
        ...
        public String getGroundTruthUrl() { return groundTruthUrl; }
    ...
    public static class Dataset {
        ...
        public DatasetDefinition getDefinition() { return definition; }
        public String getBaseVectorPath() { return baseVectorPath; }
        public String getQueryVectorPath() { return queryVectorPath; }
        public String getGroundTruthPath() { return groundTruthPath; }
        public BinaryVectorLoader.DatasetInfo getBaseInfo() { return baseInfo; }
        public BinaryVectorLoader.DatasetInfo getQueryInfo() { return queryInfo; }
    }
    ...
    public static Dataset loadDataset(String name, String cacheDir) throws IOException {
        ...
        String baseVectorPath = downloadIfNeeded(def.getBaseUrl(), cachePath.resolve("base" + getFileExtension(def.getBaseUrl())).toString());
        String queryVectorPath = downloadIfNeeded(def.getQueryUrl(), cachePath.resolve("query" + getFileExtension(def.getQueryUrl())).toString());
        String groundTruthPath = downloadIfNeeded(def.getGroundTruthUrl(), cachePath.resolve("groundtruth" + getFileExtension(def.getGroundTruthUrl())).toString());
    ...
    public static void printDatasetInfo() {
        ...
        for (DatasetDefinition def : DATASETS.values()) {
            logger.info("  {} - {} ({} dimensions, {} metric, {:.1f} GB)", 
                def.getName(), 
                def.getDescription(),
                def.getDimensions(),
                def.getMetric(),
